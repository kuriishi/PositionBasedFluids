...
namespace simulator {
    extern GLuint particlePositionsSSBO;
    ...
    const real HORIZON_MAX_COORDINATE = PARTICLE_COUNT_PER_EDGE_XZ * PARTICLE_RADIUS * 9.0;
    const real MAX_HEIGHT = (PARTICLE_COUNT_PER_EDGE_Y + 60) * PARTICLE_RADIUS * 2.0;
